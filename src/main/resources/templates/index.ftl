                            ...
                            <div class="col-md-offset-1 col-md-6 article-tags">
                                ...
                                <div >
                                    ...
                                    <#list articuloEtiqueta as etiqueta>
                                        <div class="tags">
                                            <a style="color: #ffffff;font-size:14px;margin:4px;padding:5px 5px 5px 5px;background-color:#9d9d9d;" class="glyphicon glyphicon-tags" href="/etiqueta/${etiqueta.getEtiqueta()}/articulos">${etiqueta.getEtiqueta()}</a>
                                        </div>
